...
namespace UniqueBowl.Controllers
{
    public class BowlsController : Controller
    {
        private readonly UniqueBowlContext _context;

        public BowlsController(UniqueBowlContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,design,Size,Price,Rating")] Bowl bowl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,design,Size,Price,Rating")] Bowl bowl)
        {
            if (id != bowl.Id)
            {
                return NotFound();
